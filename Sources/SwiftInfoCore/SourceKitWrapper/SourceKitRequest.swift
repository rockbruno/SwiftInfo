...
//
//        public init() {
//            dict = SourceKit.api.request_dictionary_create(nil, nil, 0)!
//        }
//
//        deinit {
//            SourceKit.api.request_release(UnsafeMutableRawPointer(dict))
//        }
//
//        public func add(_ key: SourceKitdUID, value: String) {
//            SourceKit.api.request_dictionary_set_string(dict, key.uid, value)
//        }
//
//        public func add(_ key: SourceKitdUID, value: Int) {
//            SourceKit.api.request_dictionary_set_int64(dict, key.uid, Int64(value))
//        }
//
//        public func add(_ key: SourceKitdUID, value: SourceKitdUID) {
//            SourceKit.api.request_dictionary_set_uid(dict, key.uid, value.uid)
//        }
//
//        public func add(_ key: SourceKitdUID, value: Array) {
//            SourceKit.api.request_dictionary_set_value(dict, key.uid, value.arr)
//        }
//
//        public func add(_ key: SourceKitdUID, value: Dictionary) {
//            SourceKit.api.request_dictionary_set_value(dict, key.uid, value.dict)
//        }
//
//        public func add(_ key: SourceKitdUID, value: Bool) {
//            SourceKit.api.request_dictionary_set_int64(dict, key.uid, value ? 1 : 0)
//        }
//
//        public var description: String {
//            let utf8Str = SourceKit.api.request_description_copy(dict)!
...
//
//        public init() {
//            arr = SourceKit.api.request_array_create(nil, 0)!
//        }
//
//        deinit {
//            SourceKit.api.request_release(arr)
//        }
//
//        public func add(_ value: String) {
//            SourceKit.api.request_array_set_string(arr, Append, value)
//        }
//
//        public func add(_ value: Int) {
//            SourceKit.api.request_array_set_int64(arr, Append, Int64(value))
//        }
//
//        public func add(_ value: SourceKitdUID) {
//            SourceKit.api.request_array_set_uid(arr, Append, value.uid)
//        }
//
//        public func add(_ value: Dictionary) {
//            SourceKit.api.request_array_set_value(arr, Append, value.dict)
//        }
//
//        public var description: String {
//            let utf8Str = SourceKit.api.request_description_copy(arr)!
//            let result = String(cString: utf8Str)
//            free(utf8Str)
//            return result
//        }
...
//        let request = SourceKitdUID(uid: SourceKit.api.uid_get_from_cstr("key.request")!)
...
//        let compilerArgs = SourceKitdUID(uid: SourceKit.api.uid_get_from_cstr("key.compilerargs")!)
